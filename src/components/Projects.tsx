...
import four from '../assets/project_4.png';
...
const projects = [
    ...
    {id: 5, title: 'Artistry', link: 'https://github.com/Advi23/Artistry', 
        ...
        skills: ['Java', 'JSON', 'REST API Integration', 'Project Documentation', 'Canva Design', 'GitHub'], image: four
    },
    {id: 6, title: 'CyberWise', link: 'https://github.com/Advi23/CyberWise', 
        ...
        skills: ['Swift', 'SwiftUI', 'Logo Design', 'Cybersecurity'], image: four
    },
];
